...
from .order_report1 import OrderReport1, OrderReport1Dict


class MarginOcoOrder(SdkBaseModel):
    ...
    orders: list[Order1]
    order_reports: list[OrderReport1] = Field(alias="orderReports")


class MarginOcoOrderDict(TypedDict):
    order_list_id: int
    ...
    order_reports: list[OrderReport1 | OrderReport1Dict]

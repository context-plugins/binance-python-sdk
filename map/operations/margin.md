...
Accessor: `client.margin` · Source: `binance/apis/margin.py` · 48 operations
...
| Type | Source |
| --- | --- |
| `SapiV1MarginMaxLeverageResponse` | `binance/models/sapi_v1_margin_max_leverage_response.py` |
| `AdjustCrossMarginMaxLeverageUserDataErrorBody` | `binance/errors/adjust_cross_margin_max_leverage_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginCrossMarginCollateralRatioResponse` | `binance/models/sapi_v1_margin_cross_margin_collateral_ratio_response.py` |
| `CrossMarginCollateralRatioMarketDataErrorBody` | `binance/errors/cross_margin_collateral_ratio_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginIsolatedAccountResponse` | `binance/models/sapi_v1_margin_isolated_account_response.py` |
| `DisableIsolatedMarginAccountTradeErrorBody` | `binance/errors/disable_isolated_margin_account_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `SapiV1MarginIsolatedAccountResponse` | `binance/models/sapi_v1_margin_isolated_account_response.py` |
| `EnableIsolatedMarginAccountTradeErrorBody` | `binance/errors/enable_isolated_margin_account_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginAllPairsResponse` | `binance/models/sapi_v1_margin_all_pairs_response.py` |
| `GetAllCrossMarginPairsMarketDataErrorBody` | `binance/errors/get_all_cross_margin_pairs_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginIsolatedAllPairsResponse` | `binance/models/sapi_v1_margin_isolated_all_pairs_response.py` |
| `GetAllIsolatedMarginSymbolUserDataErrorBody` | `binance/errors/get_all_isolated_margin_symbol_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginAllAssetsResponse` | `binance/models/sapi_v1_margin_all_assets_response.py` |
| `GetAllMarginAssetsMarketDataErrorBody` | `binance/errors/get_all_margin_assets_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `BnbBurnStatus` | `binance/models/bnb_burn_status.py` |
| `GetBnbBurnStatusUserDataErrorBody` | `binance/errors/get_bnb_burn_status_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Type2OrStr` | `binance/models/enums/type2.py` |
| `SapiV1MarginTransferResponse` | `binance/models/sapi_v1_margin_transfer_response.py` |
| `GetCrossMarginTransferHistoryUserDataErrorBody` | `binance/errors/get_cross_margin_transfer_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginForceLiquidationRecResponse` | `binance/models/sapi_v1_margin_force_liquidation_rec_response.py` |
| `GetForceLiquidationRecordUserDataErrorBody` | `binance/errors/get_force_liquidation_record_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginInterestHistoryResponse` | `binance/models/sapi_v1_margin_interest_history_response.py` |
| `GetInterestHistoryUserDataErrorBody` | `binance/errors/get_interest_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginExchangeSmallLiabilityResponse` | `binance/models/sapi_v1_margin_exchange_small_liability_response.py` |
| `GetSmallLiabilityExchangeCoinListUserDataErrorBody` | `binance/errors/get_small_liability_exchange_coin_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginExchangeSmallLiabilityHistoryResponse` | `binance/models/sapi_v1_margin_exchange_small_liability_history_response.py` |
| `GetSmallLiabilityExchangeHistoryUserDataErrorBody` | `binance/errors/get_small_liability_exchange_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginTradeCoeffResponse` | `binance/models/sapi_v1_margin_trade_coeff_response.py` |
| `GetSummaryOfMarginAccountUserDataErrorBody` | `binance/errors/get_summary_of_margin_account_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `SapiV1MarginNextHourlyInterestRateResponse` | `binance/models/sapi_v1_margin_next_hourly_interest_rate_response.py` |
| `GetAFutureHourlyInterestRateUserDataErrorBody` | `binance/errors/get_a_future_hourly_interest_rate_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Type3OrStr` | `binance/models/enums/type3.py` |
| `SapiV1MarginCapitalFlowResponse` | `binance/models/sapi_v1_margin_capital_flow_response.py` |
| `GetCrossOrIsolatedMarginCapitalFlowUserDataErrorBody` | `binance/errors/get_cross_or_isolated_margin_capital_flow_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginDelistScheduleResponse` | `binance/models/sapi_v1_margin_delist_schedule_response.py` |
| `GetTokensOrSymbolsDelistScheduleForCrossMarginAndIsolatedMarginMarketDataErrorBody` | `binance/errors/get_tokens_or_symbols_delist_schedule_for_cross_margin_and_isolated_margin_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginOcoOrder` | `binance/models/margin_oco_order.py` |
| `MarginAccountCancelOcoTradeErrorBody` | `binance/errors/margin_account_cancel_oco_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginOrder` | `binance/models/margin_order.py` |
| `MarginAccountCancelOrderTradeErrorBody` | `binance/errors/margin_account_cancel_order_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `SapiV1MarginOpenOrdersResponse` | `binance/models/unions/sapi_v1_margin_open_orders_response.py` |
| `MarginAccountCancelAllOpenOrdersOnASymbolTradeErrorBody` | `binance/errors/margin_account_cancel_all_open_orders_on_a_symbol_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `StopLimitTimeInForceOrStr` | `binance/models/enums/stop_limit_time_in_force.py` |
| `NewOrderRespTypeOrStr` | `binance/models/enums/new_order_resp_type.py` |
| `SideEffectTypeOrStr` | `binance/models/enums/side_effect_type.py` |
| `SelfTradePreventionModeOrStr` | `binance/models/enums/self_trade_prevention_mode.py` |
| `SapiV1MarginOrderOcoResponse` | `binance/models/sapi_v1_margin_order_oco_response.py` |
| `MarginAccountNewOcoTradeErrorBody` | `binance/errors/margin_account_new_oco_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `NewOrderRespTypeOrStr` | `binance/models/enums/new_order_resp_type.py` |
| `SideEffectType1OrStr` | `binance/models/enums/side_effect_type1.py` |
| `SelfTradePreventionModeOrStr` | `binance/models/enums/self_trade_prevention_mode.py` |
...
| `SapiV1MarginOrderOtoResponse` | `binance/models/sapi_v1_margin_order_oto_response.py` |
| `MarginAccountNewOtoTradeErrorBody` | `binance/errors/margin_account_new_oto_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| `SapiV1MarginOrderOtocoResponse` | `binance/models/sapi_v1_margin_order_otoco_response.py` |
| `MarginAccountNewOtocoTradeErrorBody` | `binance/errors/margin_account_new_otoco_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| `SelfTradePreventionModeOrStr` | `binance/models/enums/self_trade_prevention_mode.py` |
| `SapiV1MarginOrderResponse` | `binance/models/unions/sapi_v1_margin_order_response.py` |
| `MarginAccountNewOrderTradeErrorBody` | `binance/errors/margin_account_new_order_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginInterestRateHistoryResponse` | `binance/models/sapi_v1_margin_interest_rate_history_response.py` |
| `MarginInterestRateHistoryUserDataErrorBody` | `binance/errors/margin_interest_rate_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginBorrowRepayResponse` | `binance/models/sapi_v1_margin_borrow_repay_response.py` |
| `MarginAccountBorrowRepayMarginErrorBody` | `binance/errors/margin_account_borrow_repay_margin_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Type4OrStr` | `binance/models/enums/type4.py` |
| `SapiV1MarginManualLiquidationResponse` | `binance/models/sapi_v1_margin_manual_liquidation_response.py` |
| `MarginManualLiquidationMarginErrorBody` | `binance/errors/margin_manual_liquidation_margin_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginAccountResponse` | `binance/models/sapi_v1_margin_account_response.py` |
| `QueryCrossMarginAccountDetailsUserDataErrorBody` | `binance/errors/query_cross_margin_account_details_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginCrossMarginDataResponse` | `binance/models/sapi_v1_margin_cross_margin_data_response.py` |
| `QueryCrossMarginFeeDataUserDataErrorBody` | `binance/errors/query_cross_margin_fee_data_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginRateLimitOrderResponse` | `binance/models/sapi_v1_margin_rate_limit_order_response.py` |
| `QueryCurrentMarginOrderCountUsageTradeErrorBody` | `binance/errors/query_current_margin_order_count_usage_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginIsolatedAccountLimitResponse` | `binance/models/sapi_v1_margin_isolated_account_limit_response.py` |
| `QueryEnabledIsolatedMarginAccountLimitUserDataErrorBody` | `binance/errors/query_enabled_isolated_margin_account_limit_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `IsolatedMarginAccountInfo` | `binance/models/isolated_margin_account_info.py` |
| `QueryIsolatedMarginAccountInfoUserDataErrorBody` | `binance/errors/query_isolated_margin_account_info_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginIsolatedMarginDataResponse` | `binance/models/sapi_v1_margin_isolated_margin_data_response.py` |
| `QueryIsolatedMarginFeeDataUserDataErrorBody` | `binance/errors/query_isolated_margin_fee_data_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginIsolatedMarginTierResponse` | `binance/models/sapi_v1_margin_isolated_margin_tier_response.py` |
| `QueryIsolatedMarginTierDataUserDataErrorBody` | `binance/errors/query_isolated_margin_tier_data_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginLeverageBracketResponse` | `binance/models/sapi_v1_margin_leverage_bracket_response.py` |
| `QueryLiabilityCoinLeverageBracketInCrossMarginProModeMarketDataErrorBody` | `binance/errors/query_liability_coin_leverage_bracket_in_cross_margin_pro_mode_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginOrderDetail` | `binance/models/margin_order_detail.py` |
| `QueryMarginAccountSAllOrdersUserDataErrorBody` | `binance/errors/query_margin_account_s_all_orders_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `SapiV1MarginOrderListResponse` | `binance/models/sapi_v1_margin_order_list_response.py` |
| `QueryMarginAccountSOcoUserDataErrorBody` | `binance/errors/query_margin_account_s_oco_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `SapiV1MarginOpenOrderListResponse` | `binance/models/sapi_v1_margin_open_order_list_response.py` |
| `QueryMarginAccountSOpenOcoUserDataErrorBody` | `binance/errors/query_margin_account_s_open_oco_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginOrderDetail` | `binance/models/margin_order_detail.py` |
| `QueryMarginAccountSOpenOrdersUserDataErrorBody` | `binance/errors/query_margin_account_s_open_orders_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginOrderDetail` | `binance/models/margin_order_detail.py` |
| `QueryMarginAccountSOrderUserDataErrorBody` | `binance/errors/query_margin_account_s_order_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `MarginTrade` | `binance/models/margin_trade.py` |
| `QueryMarginAccountSTradeListUserDataErrorBody` | `binance/errors/query_margin_account_s_trade_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `IsIsolatedOrStr` | `binance/models/enums/is_isolated.py` |
| `SapiV1MarginAllOrderListResponse` | `binance/models/sapi_v1_margin_all_order_list_response.py` |
| `QueryMarginAccountSAllOcoUserDataErrorBody` | `binance/errors/query_margin_account_s_all_oco_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `Type4OrStr` | `binance/models/enums/type4.py` |
| `SapiV1MarginAvailableInventoryResponse` | `binance/models/sapi_v1_margin_available_inventory_response.py` |
| `QueryMarginAvailableInventoryUserDataErrorBody` | `binance/errors/query_margin_available_inventory_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginPriceIndexResponse` | `binance/models/sapi_v1_margin_price_index_response.py` |
| `QueryMarginPriceIndexMarketDataErrorBody` | `binance/errors/query_margin_price_index_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginMaxBorrowableResponse` | `binance/models/sapi_v1_margin_max_borrowable_response.py` |
| `QueryMaxBorrowUserDataErrorBody` | `binance/errors/query_max_borrow_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginMaxTransferableResponse` | `binance/models/sapi_v1_margin_max_transferable_response.py` |
| `QueryMaxTransferOutAmountUserDataErrorBody` | `binance/errors/query_max_transfer_out_amount_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MarginBorrowRepayResponse1` | `binance/models/sapi_v1_margin_borrow_repay_response1.py` |
| `QueryBorrowRepayRecordsInMarginAccountUserDataErrorBody` | `binance/errors/query_borrow_repay_records_in_margin_account_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SpotBnbburnOrStr` | `binance/models/enums/spot_bnbburn.py` |
| `InterestBnbburnOrStr` | `binance/models/enums/interest_bnbburn.py` |
| `BnbBurnStatus` | `binance/models/bnb_burn_status.py` |
| `ToggleBnbBurnOnSpotTradeAndMarginInterestUserDataErrorBody` | `binance/errors/toggle_bnb_burn_on_spot_trade_and_margin_interest_user_data_error.py` |
| `Error` | `binance/models/error.py` |

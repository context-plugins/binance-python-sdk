...
Accessor: `client.nft` · Source: `binance/apis/nft.py` · 4 operations
...
| Type | Source |
| --- | --- |
| `SapiV1NftUserGetAssetResponse` | `binance/models/sapi_v1_nft_user_get_asset_response.py` |
| `GetNftAssetUserDataErrorBody` | `binance/errors/get_nft_asset_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1NftHistoryDepositResponse` | `binance/models/sapi_v1_nft_history_deposit_response.py` |
| `GetNftDepositHistoryUserDataErrorBody` | `binance/errors/get_nft_deposit_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1NftHistoryTransactionsResponse` | `binance/models/sapi_v1_nft_history_transactions_response.py` |
| `GetNftTransactionHistoryUserDataErrorBody` | `binance/errors/get_nft_transaction_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1NftHistoryWithdrawResponse` | `binance/models/sapi_v1_nft_history_withdraw_response.py` |
| `GetNftWithdrawHistoryUserDataErrorBody` | `binance/errors/get_nft_withdraw_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |

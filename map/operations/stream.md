...
Accessor: `client.stream` · Source: `binance_public_spot_api/apis/stream.py` · 3 operations
...
| Type | Source |
| --- | --- |
| `CloseAListenKeyUserStreamErrorBody` | `binance_public_spot_api/errors/close_a_listen_key_user_stream_error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3UserDataStreamResponse` | `binance_public_spot_api/models/api_v3_user_data_stream_response.py` |
...
| Type | Source |
| --- | --- |
| `PingKeepAliveAListenKeyUserStreamApiErrorBody` | `binance_public_spot_api/errors/ping_keep_alive_a_listen_key_user_stream_api_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |

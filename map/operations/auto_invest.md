...
Accessor: `client.auto_invest` · Source: `binance/apis/auto_invest.py` · 17 operations
...
| Type | Source |
| --- | --- |
| `Status1OrStr` | `binance/models/enums/status1.py` |
| `SapiV1LendingAutoInvestPlanEditStatusResponse` | `binance/models/sapi_v1_lending_auto_invest_plan_edit_status_response.py` |
| `ChangePlanStatusErrorBody` | `binance/errors/change_plan_status_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestPlanListResponse` | `binance/models/sapi_v1_lending_auto_invest_plan_list_response.py` |
| `GetListOfPlansErrorBody` | `binance/errors/get_list_of_plans_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestTargetAssetRoiListResponse` | `binance/models/sapi_v1_lending_auto_invest_target_asset_roi_list_response.py` |
| `GetTargetAssetRoiDataUserDataErrorBody` | `binance/errors/get_target_asset_roi_data_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestTargetAssetListResponse` | `binance/models/sapi_v1_lending_auto_invest_target_asset_list_response.py` |
| `GetTargetAssetListUserDataErrorBody` | `binance/errors/get_target_asset_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestRebalanceHistoryResponse` | `binance/models/sapi_v1_lending_auto_invest_rebalance_history_response.py` |
| `IndexLinkedPlanRebalanceDetailsUserDataErrorBody` | `binance/errors/index_linked_plan_rebalance_details_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestRedeemResponse` | `binance/models/sapi_v1_lending_auto_invest_redeem_response.py` |
| `IndexLinkedPlanRedemptionTradeErrorBody` | `binance/errors/index_linked_plan_redemption_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestRedeemHistoryResponse` | `binance/models/sapi_v1_lending_auto_invest_redeem_history_response.py` |
| `IndexLinkedPlanRedemptionHistoryUserDataErrorBody` | `binance/errors/index_linked_plan_redemption_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SubscriptionCycleOrStr` | `binance/models/enums/subscription_cycle.py` |
| `SubscriptionStartWeekdayOrStr` | `binance/models/enums/subscription_start_weekday.py` |
| `Detail1` | `binance/models/detail1.py` |
| `Detail1Dict` | `binance/models/detail1.py` |
| `SapiV1LendingAutoInvestPlanEditResponse` | `binance/models/sapi_v1_lending_auto_invest_plan_edit_response.py` |
| `InvestmentPlanAdjustmentErrorBody` | `binance/errors/investment_plan_adjustment_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SourceTypeOrStr` | `binance/models/enums/source_type.py` |
| `PlanTypeOrStr` | `binance/models/enums/plan_type.py` |
| `SubscriptionCycleOrStr` | `binance/models/enums/subscription_cycle.py` |
| `Detail1` | `binance/models/detail1.py` |
| `Detail1Dict` | `binance/models/detail1.py` |
| `SubscriptionStartWeekdayOrStr` | `binance/models/enums/subscription_start_weekday.py` |
| `SapiV1LendingAutoInvestPlanAddResponse` | `binance/models/sapi_v1_lending_auto_invest_plan_add_response.py` |
| `InvestmentPlanCreationUserDataErrorBody` | `binance/errors/investment_plan_creation_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Detail5` | `binance/models/detail5.py` |
| `Detail5Dict` | `binance/models/detail5.py` |
| `SapiV1LendingAutoInvestOneOffResponse` | `binance/models/sapi_v1_lending_auto_invest_one_off_response.py` |
| `OneTimeTransactionTradeErrorBody` | `binance/errors/one_time_transaction_trade_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestIndexInfoResponse` | `binance/models/sapi_v1_lending_auto_invest_index_info_response.py` |
| `QueryIndexDetailsUserDataErrorBody` | `binance/errors/query_index_details_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestIndexUserSummaryResponse` | `binance/models/sapi_v1_lending_auto_invest_index_user_summary_response.py` |
| `QueryIndexLinkedPlanPositionDetailsUserDataErrorBody` | `binance/errors/query_index_linked_plan_position_details_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestOneOffStatusResponse` | `binance/models/sapi_v1_lending_auto_invest_one_off_status_response.py` |
| `QueryOneTimeTransactionStatusUserDataErrorBody` | `binance/errors/query_one_time_transaction_status_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestAllAssetResponse` | `binance/models/sapi_v1_lending_auto_invest_all_asset_response.py` |
| `QueryAllSourceAssetAndTargetAssetUserDataErrorBody` | `binance/errors/query_all_source_asset_and_target_asset_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestPlanIdResponse` | `binance/models/sapi_v1_lending_auto_invest_plan_id_response.py` |
| `QueryHoldingDetailsOfThePlanErrorBody` | `binance/errors/query_holding_details_of_the_plan_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1LendingAutoInvestSourceAssetListResponse` | `binance/models/sapi_v1_lending_auto_invest_source_asset_list_response.py` |
| `QuerySourceAssetListUserDataErrorBody` | `binance/errors/query_source_asset_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `PlanType1OrStr` | `binance/models/enums/plan_type1.py` |
| `SapiV1LendingAutoInvestHistoryListResponse` | `binance/models/sapi_v1_lending_auto_invest_history_list_response.py` |
| `QuerySubscriptionTransactionHistoryErrorBody` | `binance/errors/query_subscription_transaction_history_error.py` |
| `Error` | `binance/models/error.py` |

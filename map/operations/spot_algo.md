...
Accessor: `client.spot_algo` · Source: `binance/apis/spot_algo.py` · 5 operations
...
| Type | Source |
| --- | --- |
| `SapiV1AlgoSpotOrderResponse` | `binance/models/sapi_v1_algo_spot_order_response.py` |
| `CancelAlgoOrderErrorBody` | `binance/errors/cancel_algo_order_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AlgoSpotOpenOrdersResponse` | `binance/models/sapi_v1_algo_spot_open_orders_response.py` |
| `QueryCurrentAlgoOpenOrdersErrorBody` | `binance/errors/query_current_algo_open_orders_error.py` |
| `Error` | `binance/models/error.py` |
...
| `SapiV1AlgoSpotHistoricalOrdersResponse` | `binance/models/sapi_v1_algo_spot_historical_orders_response.py` |
| `QueryHistoricalAlgoOrdersErrorBody` | `binance/errors/query_historical_algo_orders_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AlgoSpotSubOrdersResponse` | `binance/models/sapi_v1_algo_spot_sub_orders_response.py` |
| `QuerySubOrdersErrorBody` | `binance/errors/query_sub_orders_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `SideOrStr` | `binance/models/enums/side.py` |
| `SapiV1AlgoSpotNewOrderTwapResponse` | `binance/models/sapi_v1_algo_spot_new_order_twap_response.py` |
| `TimeWeightedAveragePriceTwapNewOrderErrorBody` | `binance/errors/time_weighted_average_price_twap_new_order_error.py` |
| `Error` | `binance/models/error.py` |

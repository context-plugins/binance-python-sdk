...
Accessor: `client.fiat` · Source: `binance_public_spot_api/apis/fiat.py` · 2 operations
...
| Type | Source |
| --- | --- |
| `SapiV1FiatOrdersResponse` | `binance_public_spot_api/models/sapi_v1_fiat_orders_response.py` |
| `FiatDepositWithdrawHistoryUserDataErrorBody` | `binance_public_spot_api/errors/fiat_deposit_withdraw_history_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1FiatPaymentsResponse` | `binance_public_spot_api/models/sapi_v1_fiat_payments_response.py` |
| `FiatPaymentsHistoryUserDataErrorBody` | `binance_public_spot_api/errors/fiat_payments_history_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |

...
Accessor: `client.pay` · Source: `binance/apis/pay.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `SapiV1PayTransactionsResponse` | `binance/models/sapi_v1_pay_transactions_response.py` |
| `GetPayTradeHistoryUserDataErrorBody` | `binance/errors/get_pay_trade_history_user_data_error.py` |

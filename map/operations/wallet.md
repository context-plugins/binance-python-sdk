...
Accessor: `client.wallet` · Source: `binance/apis/wallet.py` · 34 operations
...
| Type | Source |
| --- | --- |
| `SapiV1AccountApiTradingStatusResponse` | `binance/models/sapi_v1_account_api_trading_status_response.py` |
| `AccountApiTradingStatusUserDataErrorBody` | `binance/errors/account_api_trading_status_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AccountStatusResponse` | `binance/models/sapi_v1_account_status_response.py` |
| `AccountStatusUserDataErrorBody` | `binance/errors/account_status_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AccountInfoResponse` | `binance/models/sapi_v1_account_info_response.py` |
| `AccountInfoUserDataErrorBody` | `binance/errors/account_info_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalConfigGetallResponse` | `binance/models/sapi_v1_capital_config_getall_response.py` |
| `AllCoinsInformationUserDataErrorBody` | `binance/errors/all_coins_information_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetAssetDetailResponse` | `binance/models/sapi_v1_asset_asset_detail_response.py` |
| `AssetDetailUserDataErrorBody` | `binance/errors/asset_detail_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetAssetDividendResponse` | `binance/models/sapi_v1_asset_asset_dividend_response.py` |
| `AssetDividendRecordUserDataErrorBody` | `binance/errors/asset_dividend_record_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetConvertTransferResponse` | `binance/models/sapi_v1_asset_convert_transfer_response.py` |
| `ConvertTransferUserDataErrorBody` | `binance/errors/convert_transfer_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Type6OrStr` | `binance/models/enums/type6.py` |
| `SapiV1AccountSnapshotResponse` | `binance/models/unions/sapi_v1_account_snapshot_response.py` |
| `DailyAccountSnapshotUserDataErrorBody` | `binance/errors/daily_account_snapshot_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalDepositAddressResponse` | `binance/models/sapi_v1_capital_deposit_address_response.py` |
| `DepositAddressSupportingNetworkUserDataErrorBody` | `binance/errors/deposit_address_supporting_network_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalDepositHisrecResponse` | `binance/models/sapi_v1_capital_deposit_hisrec_response.py` |
| `DepositHistorySupportingNetworkUserDataErrorBody` | `binance/errors/deposit_history_supporting_network_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `DisableFastWithdrawSwitchUserDataErrorBody` | `binance/errors/disable_fast_withdraw_switch_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `AccountTypeOrStr` | `binance/models/enums/account_type.py` |
| `SapiV1AssetDustResponse` | `binance/models/sapi_v1_asset_dust_response.py` |
| `DustTransferUserDataErrorBody` | `binance/errors/dust_transfer_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `AccountTypeOrStr` | `binance/models/enums/account_type.py` |
| `SapiV1AssetDribbletResponse` | `binance/models/sapi_v1_asset_dribblet_response.py` |
| `DustLogUserDataErrorBody` | `binance/errors/dust_log_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `EnableFastWithdrawSwitchUserDataErrorBody` | `binance/errors/enable_fast_withdraw_switch_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalDepositAddressListResponse` | `binance/models/sapi_v1_capital_deposit_address_list_response.py` |
| `FetchDepositAddressListWithNetworkUserDataErrorBody` | `binance/errors/fetch_deposit_address_list_with_network_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalWithdrawAddressListResponse` | `binance/models/sapi_v1_capital_withdraw_address_list_response.py` |
| `FetchWithdrawAddressListUserDataErrorBody` | `binance/errors/fetch_withdraw_address_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `NeedBtcValuationOrStr` | `binance/models/enums/need_btc_valuation.py` |
| `SapiV1AssetGetFundingAssetResponse` | `binance/models/sapi_v1_asset_get_funding_asset_response.py` |
| `FundingWalletUserDataErrorBody` | `binance/errors/funding_wallet_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AccountApiRestrictionsResponse` | `binance/models/sapi_v1_account_api_restrictions_response.py` |
| `GetApiKeyPermissionUserDataErrorBody` | `binance/errors/get_api_key_permission_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `AccountTypeOrStr` | `binance/models/enums/account_type.py` |
| `SapiV1AssetDustBtcResponse` | `binance/models/sapi_v1_asset_dust_btc_response.py` |
| `GetAssetsThatCanBeConvertedIntoBnbUserDataErrorBody` | `binance/errors/get_assets_that_can_be_converted_into_bnb_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetLedgerTransferCloudMiningQueryByPageResponse` | `binance/models/sapi_v1_asset_ledger_transfer_cloud_mining_query_by_page_response.py` |
| `GetCloudMiningPaymentAndRefundHistoryUserDataErrorBody` | `binance/errors/get_cloud_mining_payment_and_refund_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1SpotDelistScheduleResponse` | `binance/models/sapi_v1_spot_delist_schedule_response.py` |
| `GetSymbolsDelistScheduleForSpotMarketDataErrorBody` | `binance/errors/get_symbols_delist_schedule_for_spot_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalDepositCreditApplyResponse` | `binance/models/sapi_v1_capital_deposit_credit_apply_response.py` |
| `OneClickArrivalDepositApplyUserDataErrorBody` | `binance/errors/one_click_arrival_deposit_apply_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `AccountType3OrStr` | `binance/models/enums/account_type3.py` |
| `SapiV1AssetConvertTransferQueryByPageResponse` | `binance/models/sapi_v1_asset_convert_transfer_query_by_page_response.py` |
| `QueryConvertTransferUserDataErrorBody` | `binance/errors/query_convert_transfer_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetCustodyTransferHistoryResponse` | `binance/models/sapi_v1_asset_custody_transfer_history_response.py` |
| `QueryUserDelegationHistoryForMasterAccountUserDataErrorBody` | `binance/errors/query_user_delegation_history_for_master_account_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `Type7OrStr` | `binance/models/enums/type7.py` |
| `SapiV1AssetTransferResponse` | `binance/models/sapi_v1_asset_transfer_response.py` |
| `QueryUserUniversalTransferHistoryUserDataErrorBody` | `binance/errors/query_user_universal_transfer_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetWalletBalanceResponse` | `binance/models/sapi_v1_asset_wallet_balance_response.py` |
| `QueryUserWalletBalanceUserDataErrorBody` | `binance/errors/query_user_wallet_balance_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalContractConvertibleCoinsResponse` | `binance/models/sapi_v1_capital_contract_convertible_coins_response.py` |
| `QueryAutoConvertingStableCoinsUserDataErrorBody` | `binance/errors/query_auto_converting_stable_coins_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SwitchOnOffBusdAndStableCoinsConversionUserDataUserDataErrorBody` | `binance/errors/switch_on_off_busd_and_stable_coins_conversion_user_data_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1SystemStatusResponse` | `binance/models/sapi_v1_system_status_response.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1AssetTradeFeeResponse` | `binance/models/sapi_v1_asset_trade_fee_response.py` |
| `TradeFeeUserDataErrorBody` | `binance/errors/trade_fee_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `NeedBtcValuationOrStr` | `binance/models/enums/need_btc_valuation.py` |
| `SapiV3AssetGetUserAssetResponse` | `binance/models/sapi_v3_asset_get_user_asset_response.py` |
| `UserAssetUserDataErrorBody` | `binance/errors/user_asset_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| --- | --- |
| `Type7OrStr` | `binance/models/enums/type7.py` |
| `SapiV1AssetTransferResponse1` | `binance/models/sapi_v1_asset_transfer_response1.py` |
| `UserUniversalTransferUserDataErrorBody` | `binance/errors/user_universal_transfer_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalWithdrawApplyResponse` | `binance/models/sapi_v1_capital_withdraw_apply_response.py` |
| `WithdrawUserDataErrorBody` | `binance/errors/withdraw_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1CapitalWithdrawHistoryResponse` | `binance/models/sapi_v1_capital_withdraw_history_response.py` |
| `WithdrawHistorySupportingNetworkUserDataErrorBody` | `binance/errors/withdraw_history_supporting_network_user_data_error.py` |
| `Error` | `binance/models/error.py` |

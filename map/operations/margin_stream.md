...
Accessor: `client.margin_stream` · Source: `binance_public_spot_api/apis/margin_stream.py` · 3 operations
...
| Type | Source |
| --- | --- |
| `CloseAListenKeyUserStream2ErrorBody` | `binance_public_spot_api/errors/close_a_listen_key_user_stream2_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1UserDataStreamResponse` | `binance_public_spot_api/models/sapi_v1_user_data_stream_response.py` |
...
| Type | Source |
| --- | --- |
| `PingKeepAliveAListenKeyUserStream2ErrorBody` | `binance_public_spot_api/errors/ping_keep_alive_a_listen_key_user_stream2_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |

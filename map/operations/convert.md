...
Accessor: `client.convert` · Source: `binance/apis/convert.py` · 9 operations
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertAcceptQuoteResponse` | `binance/models/sapi_v1_convert_accept_quote_response.py` |
| `AcceptQuoteTradeErrorBody` | `binance/errors/accept_quote_trade_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertLimitCancelOrderResponse` | `binance/models/sapi_v1_convert_limit_cancel_order_response.py` |
| `CancelLimitOrderUserDataErrorBody` | `binance/errors/cancel_limit_order_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertTradeFlowResponse` | `binance/models/sapi_v1_convert_trade_flow_response.py` |
| `GetConvertTradeHistoryUserDataErrorBody` | `binance/errors/get_convert_trade_history_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertExchangeInfoResponse` | `binance/models/sapi_v1_convert_exchange_info_response.py` |
| `ListAllConvertPairsErrorBody` | `binance/errors/list_all_convert_pairs_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertOrderStatusResponse` | `binance/models/sapi_v1_convert_order_status_response.py` |
| `OrderStatusUserDataErrorBody` | `binance/errors/order_status_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| `WalletTypeOrStr` | `binance/models/enums/wallet_type.py` |
| `ExpiredTypeOrStr` | `binance/models/enums/expired_type.py` |
| `SapiV1ConvertLimitPlaceOrderResponse` | `binance/models/sapi_v1_convert_limit_place_order_response.py` |
| `PlaceLimitOrderUserDataErrorBody` | `binance/errors/place_limit_order_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertLimitQueryOpenOrdersResponse` | `binance/models/sapi_v1_convert_limit_query_open_orders_response.py` |
| `QueryLimitOpenOrdersUserDataErrorBody` | `binance/errors/query_limit_open_orders_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertAssetInfoResponse` | `binance/models/sapi_v1_convert_asset_info_response.py` |
| `QueryOrderQuantityPrecisionPerAssetUserDataErrorBody` | `binance/errors/query_order_quantity_precision_per_asset_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1ConvertGetQuoteResponse` | `binance/models/sapi_v1_convert_get_quote_response.py` |
| `SendQuoteRequestUserDataErrorBody` | `binance/errors/send_quote_request_user_data_error.py` |
| `Error` | `binance/models/error.py` |

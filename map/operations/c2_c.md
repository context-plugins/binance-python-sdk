...
Accessor: `client.c2_c` · Source: `binance/apis/c2_c.py` · 1 operation
...
| Type | Source |
| --- | --- |
| `TradeTypeOrStr` | `binance/models/enums/trade_type.py` |
| `SapiV1C2COrderMatchListUserOrderHistoryResponse` | `binance/models/sapi_v1_c2_c_order_match_list_user_order_history_response.py` |
| `GetC2CTradeHistoryUserDataErrorBody` | `binance/errors/get_c2_c_trade_history_user_data_error.py` |

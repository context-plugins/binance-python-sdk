...
Accessor: `client.isolated_margin_stream` · Source: `binance_public_spot_api/apis/isolated_margin_stream.py` · 3 operations
...
| Type | Source |
| --- | --- |
| `CloseAListenKeyUserStream3ErrorBody` | `binance_public_spot_api/errors/close_a_listen_key_user_stream3_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1UserDataStreamIsolatedResponse` | `binance_public_spot_api/models/sapi_v1_user_data_stream_isolated_response.py` |
...
| Type | Source |
| --- | --- |
| `PingKeepAliveAListenKeyUserStreamErrorBody` | `binance_public_spot_api/errors/ping_keep_alive_a_listen_key_user_stream_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |

...
Accessor: `client.trade_api` · Source: `binance_public_spot_api/apis/trade_api.py` · 23 operations
...
| Type | Source |
| --- | --- |
| `Account` | `binance_public_spot_api/models/account.py` |
| `AccountInformationUserDataErrorBody` | `binance_public_spot_api/errors/account_information_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `MyTrade` | `binance_public_spot_api/models/my_trade.py` |
| `AccountTradeListUserDataErrorBody` | `binance_public_spot_api/errors/account_trade_list_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `OrderDetails` | `binance_public_spot_api/models/order_details.py` |
| `AllOrdersUserDataErrorBody` | `binance_public_spot_api/errors/all_orders_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `OcoOrder` | `binance_public_spot_api/models/oco_order.py` |
| `CancelOcoTradeErrorBody` | `binance_public_spot_api/errors/cancel_oco_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `CancelRestrictionsOrStr` | `binance_public_spot_api/models/enums/cancel_restrictions.py` |
| `Order` | `binance_public_spot_api/models/order.py` |
| `CancelOrderTradeErrorBody` | `binance_public_spot_api/errors/cancel_order_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3OpenOrdersResponse` | `binance_public_spot_api/models/unions/api_v3_open_orders_response.py` |
| `CancelAllOpenOrdersOnASymbolTradeErrorBody` | `binance_public_spot_api/errors/cancel_all_open_orders_on_a_symbol_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `ApiV3OrderCancelReplaceResponse` | `binance_public_spot_api/models/api_v3_order_cancel_replace_response.py` |
| `CancelAnExistingOrderAndSendANewOrderTradeErrorBody` | `binance_public_spot_api/errors/cancel_an_existing_order_and_send_a_new_order_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| --- | --- |
| `OrderDetails` | `binance_public_spot_api/models/order_details.py` |
| `CurrentOpenOrdersUserDataErrorBody` | `binance_public_spot_api/errors/current_open_orders_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `NewOrderRespTypeOrStr` | `binance_public_spot_api/models/enums/new_order_resp_type.py` |
| `SelfTradePreventionModeOrStr` | `binance_public_spot_api/models/enums/self_trade_prevention_mode.py` |
| `ApiV3OrderResponse` | `binance_public_spot_api/models/unions/api_v3_order_response.py` |
| `NewOrderTradeErrorBody` | `binance_public_spot_api/errors/new_order_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `ApiV3OrderListOtoResponse` | `binance_public_spot_api/models/api_v3_order_list_oto_response.py` |
| `NewOrderListOtoTradeErrorBody` | `binance_public_spot_api/errors/new_order_list_oto_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `ApiV3OrderListOtocoResponse` | `binance_public_spot_api/models/api_v3_order_list_otoco_response.py` |
| `NewOrderListOtocoTradeErrorBody` | `binance_public_spot_api/errors/new_order_list_otoco_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| --- | --- |
| `SideOrStr` | `binance_public_spot_api/models/enums/side.py` |
| `AboveTimeInForceOrStr` | `binance_public_spot_api/models/enums/above_time_in_force.py` |
| `BelowTimeInForceOrStr` | `binance_public_spot_api/models/enums/below_time_in_force.py` |
| `NewOrderRespTypeOrStr` | `binance_public_spot_api/models/enums/new_order_resp_type.py` |
| `SelfTradePreventionModeOrStr` | `binance_public_spot_api/models/enums/self_trade_prevention_mode.py` |
| `ApiV3OrderListOcoResponse` | `binance_public_spot_api/models/api_v3_order_list_oco_response.py` |
| `NewOrderListOcoTradeErrorBody` | `binance_public_spot_api/errors/new_order_list_oco_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `NewOrderRespTypeOrStr` | `binance_public_spot_api/models/enums/new_order_resp_type.py` |
| `SelfTradePreventionModeOrStr` | `binance_public_spot_api/models/enums/self_trade_prevention_mode.py` |
| `ApiV3SorOrderResponse` | `binance_public_spot_api/models/api_v3_sor_order_response.py` |
| `NewOrderUsingSorTradeErrorBody` | `binance_public_spot_api/errors/new_order_using_sor_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3MyAllocationsResponse` | `binance_public_spot_api/models/api_v3_my_allocations_response.py` |
| `QueryAllocationsUserDataErrorBody` | `binance_public_spot_api/errors/query_allocations_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3AccountCommissionResponse` | `binance_public_spot_api/models/api_v3_account_commission_response.py` |
| `QueryCommissionRatesUserDataErrorBody` | `binance_public_spot_api/errors/query_commission_rates_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3RateLimitOrderResponse` | `binance_public_spot_api/models/api_v3_rate_limit_order_response.py` |
| `QueryCurrentOrderCountUsageTradeErrorBody` | `binance_public_spot_api/errors/query_current_order_count_usage_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3OrderListResponse` | `binance_public_spot_api/models/api_v3_order_list_response.py` |
| `QueryOcoUserDataErrorBody` | `binance_public_spot_api/errors/query_oco_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3OpenOrderListResponse` | `binance_public_spot_api/models/api_v3_open_order_list_response.py` |
| `QueryOpenOcoUserDataErrorBody` | `binance_public_spot_api/errors/query_open_oco_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| --- | --- |
| `OrderDetails` | `binance_public_spot_api/models/order_details.py` |
| `QueryOrderUserDataErrorBody` | `binance_public_spot_api/errors/query_order_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3MyPreventedMatchesResponse` | `binance_public_spot_api/models/api_v3_my_prevented_matches_response.py` |
| `QueryPreventedMatchesErrorBody` | `binance_public_spot_api/errors/query_prevented_matches_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| Type | Source |
| --- | --- |
| `ApiV3AllOrderListResponse` | `binance_public_spot_api/models/api_v3_all_order_list_response.py` |
| `QueryAllOcoUserDataErrorBody` | `binance_public_spot_api/errors/query_all_oco_user_data_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `TimeInForceOrStr` | `binance_public_spot_api/models/enums/time_in_force.py` |
| `NewOrderRespTypeOrStr` | `binance_public_spot_api/models/enums/new_order_resp_type.py` |
| `TestNewOrderTradeErrorBody` | `binance_public_spot_api/errors/test_new_order_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |
...
| `NewOrderRespTypeOrStr` | `binance_public_spot_api/models/enums/new_order_resp_type.py` |
| `SelfTradePreventionModeOrStr` | `binance_public_spot_api/models/enums/self_trade_prevention_mode.py` |
| `TestNewOrderUsingSorTradeErrorBody` | `binance_public_spot_api/errors/test_new_order_using_sor_trade_error.py` |
| `Error` | `binance_public_spot_api/models/error.py` |

...
Accessor: `client.mining` · Source: `binance/apis/mining.py` · 13 operations
...
| Type | Source |
| --- | --- |
| `SapiV1MiningStatisticsUserListResponse` | `binance/models/sapi_v1_mining_statistics_user_list_response.py` |
| `AccountListUserDataErrorBody` | `binance/errors/account_list_user_data_error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningPubAlgoListResponse` | `binance/models/sapi_v1_mining_pub_algo_list_response.py` |
| `AcquiringAlgorithmMarketDataErrorBody` | `binance/errors/acquiring_algorithm_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningPubCoinListResponse` | `binance/models/sapi_v1_mining_pub_coin_list_response.py` |
| `AcquiringCoinNameMarketDataErrorBody` | `binance/errors/acquiring_coin_name_market_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningHashTransferConfigCancelResponse` | `binance/models/sapi_v1_mining_hash_transfer_config_cancel_response.py` |
| `CancelHashrateResaleConfigurationUserDataErrorBody` | `binance/errors/cancel_hashrate_resale_configuration_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningPaymentListResponse` | `binance/models/sapi_v1_mining_payment_list_response.py` |
| `EarningsListUserDataErrorBody` | `binance/errors/earnings_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningPaymentOtherResponse` | `binance/models/sapi_v1_mining_payment_other_response.py` |
| `ExtraBonusListUserDataErrorBody` | `binance/errors/extra_bonus_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningHashTransferProfitDetailsResponse` | `binance/models/sapi_v1_mining_hash_transfer_profit_details_response.py` |
| `HashrateResaleDetailsUserDataErrorBody` | `binance/errors/hashrate_resale_details_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningHashTransferConfigDetailsListResponse` | `binance/models/sapi_v1_mining_hash_transfer_config_details_list_response.py` |
| `HashrateResaleListUserDataErrorBody` | `binance/errors/hashrate_resale_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningHashTransferConfigResponse` | `binance/models/sapi_v1_mining_hash_transfer_config_response.py` |
| `HashrateResaleRequestUserDataErrorBody` | `binance/errors/hashrate_resale_request_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningPaymentUidResponse` | `binance/models/sapi_v1_mining_payment_uid_response.py` |
| `MiningAccountEarningUserDataErrorBody` | `binance/errors/mining_account_earning_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningWorkerDetailResponse` | `binance/models/sapi_v1_mining_worker_detail_response.py` |
| `RequestForDetailMinerListUserDataErrorBody` | `binance/errors/request_for_detail_miner_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningWorkerListResponse` | `binance/models/sapi_v1_mining_worker_list_response.py` |
| `RequestForMinerListUserDataErrorBody` | `binance/errors/request_for_miner_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |
...
| Type | Source |
| --- | --- |
| `SapiV1MiningStatisticsUserStatusResponse` | `binance/models/sapi_v1_mining_statistics_user_status_response.py` |
| `StatisticListUserDataErrorBody` | `binance/errors/statistic_list_user_data_error.py` |
| `Error` | `binance/models/error.py` |

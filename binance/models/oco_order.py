...
from .order_report import OrderReport, OrderReportDict


class OcoOrder(SdkBaseModel):
    ...
    symbol: str
    orders: list[Order1]
    order_reports: list[OrderReport] = Field(alias="orderReports")


class OcoOrderDict(TypedDict):
    order_list_id: int
    ...
    order_reports: list[OrderReport | OrderReportDict]
